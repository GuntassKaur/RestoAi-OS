  ...
  return (
    <div className="min-h-screen p-8 bg-[#020617] text-white font-mono space-y-8">
      <div className="flex items-center gap-4 border-b border-white/10 pb-6">
        ...
        <div>
          <h1 className="text-2xl font-black uppercase tracking-widest">RestoAI Diagnostic Console</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="glass-panel p-6 rounded-2xl space-y-4">
           ...
           <div className="bg-black/40 p-5 rounded-xl border border-white/5 space-y-4 text-xs leading-relaxed text-slate-400">
              ...
              <p>3. <b className="text-white">One-Click Fix:</b> Double click the <code className="text-emerald-400">FIX_RESTOAI.bat</code> file in your main folder.</p>
